    ...
    <div className="space-y-6">
      ...
      <div className="grid min-w-0 gap-5 xl:grid-cols-[minmax(0,400px)_1fr]">
        <form onSubmit={submit} className="min-w-0 rounded-2xl border border-neutral-200/80 bg-white p-4 shadow-2xs dark:border-neutral-800 dark:bg-[#0c0c0e] sm:p-5">
          <div className="mb-1 flex items-center gap-2"><Reicon name="calendar-days" size={16} /><h2 className="text-sm font-semibold">New leave request</h2></div>
        ...
        <div className="space-y-5">
          <section className="min-w-0 rounded-2xl border border-neutral-200/80 bg-white p-4 shadow-2xs dark:border-neutral-800 dark:bg-[#0c0c0e] sm:p-5">
            <div className="mb-4 flex items-center gap-2"><Reicon name="file-text" size={16} /><h2 className="text-sm font-semibold">Your requests</h2></div>
            {isLoading && requests.length === 0 ? (
              <LoadingState label="Loading your leave requests…" className="min-h-24" />
            ) : !requests.length ? (
              <div className="flex flex-col items-center justify-center py-6 text-center">
                <Reillustration name="empty-leave" size="sm" />
                <p className="text-xs font-semibold text-neutral-800 dark:text-neutral-200 mt-2">No leave requests yet</p>
