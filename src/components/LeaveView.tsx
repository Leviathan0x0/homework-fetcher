      ...
      <div className="grid min-w-0 gap-5 xl:grid-cols-[minmax(0,400px)_1fr]">
        <form onSubmit={submit} className="min-w-0 rounded-2xl border border-neutral-200/80 bg-white p-4 shadow-2xs dark:border-neutral-800 dark:bg-[#0c0c0e] sm:p-5">
          ...
          <div className="space-y-3">
            ...
            <button className="inline-flex h-10 w-full items-center justify-center gap-2 rounded-xl bg-neutral-900 text-xs font-semibold text-white hover:bg-neutral-700 dark:bg-white dark:text-neutral-900"><InteractiveAnimatedIcon icon={SendIcon} size={14} className="size-3.5" /> Submit request</button>
          </div>
        </form>
