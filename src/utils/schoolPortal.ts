...
export const EDUSECURE_LOGIN_URL =
  'https://edusecure.in/ManavMangalMohali/ParentApp/Login.aspx';

export const EDUSECURE_CHANGE_PASSWORD_URL =
  'https://edusecure.in/ManavMangalMohali/ParentApp/ChangePassword.aspx';
