...
/** Canonical subject names for pickers and filters (source of truth: SUBJECT_RULES). */
export const CANONICAL_SUBJECT_NAMES: string[] = SUBJECT_RULES.map((rule) => rule.name);
